...
/**
 * Controller for vehicles that operate on both land and water.
 * <br>
...
public class HybridVehicleController extends VehicleController {
	 ...
	 */
	public HybridVehicleController ( @NotNull Vehicle vehicle ,
	...
	protected boolean worksOn ( @NotNull Map < EnumSurface, Double > surface ) {
		return surface.containsKey ( EnumSurface.SOLID )
				...
				|| surface.containsKey ( EnumSurface.WATER )
